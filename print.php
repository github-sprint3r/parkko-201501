...
if(isset($_GET['id'])) {
	$data = array(
			...
			'money_in' =>2000,
			'money_out' =>470,
			'money_out_text' =>'แบงค์ 100 จำนวน 4 ใบ<br/>แบงค์ 50 จำนวน 1 ใบ<br/>แบงค์ 20 จำนวน 1 ใบ'
			);
} else {
	$data = array(
			'id' =>'ณข 1597',
			...
			'money_in' =>500,
			'money_out' =>370,
			'money_out_text' =>'แบงค์ 100 จำนวน 3 ใบ<br/>แบงค์ 50 จำนวน 1 ใบ<br/>แบงค์ 20 จำนวน 1 ใบ'
	);
}
?>
<!DOCTYPE html>
